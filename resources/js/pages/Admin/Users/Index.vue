                        ...
                        <table class="min-w-full divide-y divide-border">
                            ...
                            <tbody class="divide-y divide-border">
                                <tr v-for="user in props.users" :key="user.id">
                                   <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-foreground sm:pl-0">
                <Link 
        ...
        <Dialog :open="isPanicModalOpen" @update:open="isPanicModalOpen = $event">
            <DialogContent class="sm:max-w-lg">
                <DialogHeader>
                    ...
                    <DialogDescription>
                        Estás a punto de bloquear las cuentas de TODOS los usuarios. Esta acción es irreversible a través de la interfaz. 
